                ...
                <div className='col-md-12 background_color_universal'>
                        ...
                        <div className='col-md-12 mt-5 pb-5'>
                            <div className='row'>
                                ...
                                <div className='col-md-6 mt-md-0 mt-5 text-center'>
                                    <img className='img-fluid' data-aos="zoom-in" src='/imagess/tt.webp' />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='col-md-12 universal_padding'>
                        ...
                        <p className='m-0 p-0 yapay_head1'>
                            This contract is between you and Yafpay Inc. (“Yafpay”, “we”, “us”, or “our” as applicable), and covers all aspects of your use of our Services, which include the website, app and any other materials produced by Yafpay. These terms apply in full force and when you create a Yafpay Account, access our Services, or otherwise interact with us, you agree to be bound by this Agreement and agree to receive communication relating to the Services or your Yafpay Account in electronic format. Additionally, you affirm that you are at least eighteen (18) years old and legally allowed to enter into this Agreement. You expressly accept all Terms and Conditions contained herein in full and without limitation or qualification, including our: Privacy Policy and Acceptable Use Policy. You must not use any of the Services if you have any objection to any of these terms.
                    ...
                    <div className='col-md-12 universal_padding mt-5'>
                        ...
                        <p className='m-0 p-0 yapay_head1'>
                            This Terms of Service is an Agreement between you and Yafpay. It sets forth the terms and conditions that shall govern the use of the Platform and the services. It details Yafpay’s obligations to you. It also highlights certain risks on using the services and you must consider such risks carefully as the provision of this Agreement will bind you through your use of this website or any of our services.
                            Our Services permit you to move money in supported currencies, send or receive money into your Yafpay Balance, keep amounts in your Yafpay Balance, convert currency balances to balances in other supported currencies, pull out funds held in your Yafpay Balance, and send funds to recipients. We carry the sole authority to refuse to accept any user or to complete any command to transmit, receive, send, withdraw or convert money held in your Yafpay Account at any time.
                    ...
                    <div className='col-md-12 universal_padding mt-5'>
                        <p className='m-0 p-0 yapay_head'>PURPOSE AND SCOPE OF AGREEMENT</p>
                        <p className='m-0 p-0 yapay_head1'>
                            <LuDot /> To use Yafpay, you have to create a Yafpay account by registering. To register, you will provide us with certain information such as your email, first name, last name, business name and phone number and we may seek to verify your information, (by ourselves or through third parties), after which we will approve your account unless deemed risky. You permit us to do all these.
                    ...
                    <div className='col-md-12 universal_padding mt-5'>
                        ...
                        <p className='m-0 p-0 yapay_head1'>
                            You are solely responsible for maintaining adequate security and control of any email IDs, passwords, or other details you use to access your Yafpay Account and Services. You agree not to allow anyone else to have or use your password details and comply with all reasonable instructions regarding account access and security. In the event you share your password details, Yafpay will not be liable to you for losses or damages. You will also take all reasonable steps to protect the security of the personal electronic device through which you access Yafpay’s services (including, without limitation, enabling 2FA, using PIN and/or password-protected personally configured device functionality to access Yafpay’s services and not sharing your device with other people). Immediately change your password and contact Yafpay customer support if:
                        </p>
                        <p className='m-0 p-0 yapay_head1'>
                            <ul className='mb-0'>
                                <li>anyone asks for your password, OTP or any other security-related aspect of your Yafpay Account.</li>
                                <li>your email address becomes compromised.</li>
                                <li>you suspect your Yafpay Account or login details including your password or any other security features are stolen, lost, used without authorization or otherwise compromised.</li>
                                <li>your transaction history for your Yafpay Account shows transactions that you did not initiate.
                                </li>
                            </ul>
                        </p>
                        <p className='m-0 p-0 yapay_head1'>
                            We may suspend your Yafpay Account or otherwise restrict its functionality if we have concerns about the security of the Yafpay Account or any of its security features; or potential unauthorized or fraudulent use of your Yafpay Account or any of its security features.
                        </p>
                    </div>
                    <div className='col-md-12 universal_padding mt-5'>
                        <p className='m-0 p-0 yapay_head'>AGE RESTRICTION</p>
                        <p className='m-0 p-0 yapay_head1'>
                            Our website and services are directed to people aged 18 and above. You are only permitted to use the Services if you are 18 or older. We do not knowingly engage people younger than the age of 18.
                        </p>
                    </div>
                    <div className='col-md-12 universal_padding mt-5'>
                        <p className='m-0 p-0 yapay_head'>SOFTWARE LICENSE</p>
                        <p className='m-0 p-0 yapay_head1'>
                            For businesses, we hereby grant you a revocable, non-exclusive, non-transferable license to use Yafpay’s APIs, developer’s toolkit, and other software applications (the “Software”) in accordance with the documentation accompanying the Software. This license grant includes all updates, upgrades, new versions and replacement software for your use in connection with Yafpay’s services. If you do not comply with the documentation and any other requirements provided by Yafpay, then you will be liable for all resulting damages suffered by you, Yafpay and third parties. Unless otherwise provided by applicable law, you agree not to alter, reproduce, adapt, distribute, display, publish, reverse engineer, translate, disassemble, decompile or otherwise attempt to create any source code that is derived from the Software. Upon expiration or termination of this Agreement, you will immediately cease all use of any Software.
                        </p>
                    </div>
                    <div className='col-md-12 universal_padding mt-5'>
                        <p className='m-0 p-0 yapay_head'>WARRANTIES AND REPRESENTATIONS</p>
                        <p className='m-0 p-0 yapay_head1'>
                            You represent and warrant to Yafpay that:
                        </p>
                        <p className='m-0 p-0 yapay_head1'>
                            <ul className='mb-0'>
                                ...
                                <li>You are duly organised, authorised and in good standing under the laws of any state, region or country of your organisation. You are duly authorised to do business in all other states, regions or countries in which your business operates.</li>
                            </ul>
                        </p>
                    </div>
                    <div className='col-md-12 universal_padding mt-5'>
                        ...
                        <p className='m-0 p-0 yapay_head1'>
                            You agree to pay us for the services we render. Our Fees will be calculated as demonstrated on the Pricing page on the website. Subject to the terms of this Agreement, Yafpay will send to your designated bank or card settlement account (“Bank Account”) all amounts settled and due to you from your transactions, minus our stated fees, any Reversals, Invalidated Payments, Chargebacks, Reversals, Refunds or other amounts that you owe to Yafpay under this Agreement (“Payout”). Should either Party in good faith have cause to dispute any amount appearing on an invoice submitted by the other Party pursuant to this Agreement (“Affected Invoice”), the affected Party shall, within Forty-Eight (48) hours of receipt of the Affected Invoice, notify the other Party in writing, of such dispute, specifying the Affected Invoice, the specific amount in dispute and alleged reasons or grounds for dispute, failing which it will be deemed that the invoice is true and correct. We reserve the right to revise our fees. In the event that we revise our fees, we will notify you within twenty-four (24) hours of such change.‍
                        </p>
                    </div>
                    <div className='col-md-12 universal_padding mt-5'>
                        <p className='m-0 p-0 yapay_head'>VIRTUAL CARDS</p>
                        <p className='m-0 p-0 yapay_head1'>

                            ‍Grey provides Virtual Cards in conjunction with its bank account. You can find frequently asked questions (FAQs) regarding these virtual cards linked here
                            In the event that you initiate two repeated transactions with insufficient funds using the Yafpay card, our system will detect and flag your account, resulting in a temporary freeze of the card’s functionality. Should this particular scenario repeat for a consecutive total of four instances, the card will be subject to immediate termination.
                    ...
                    <div className='col-md-12 universal_padding mt-5'>
                        <p className='m-0 p-0 yapay_head'>TRANSACTIONS, SERVICES AND PAYMENTS</p>
                        <p className='m-0 p-0 yapay_head1'>
                            You can deposit money to your Yafpay Account through one or more methods such as; bank transfer (ACH, wire or swift, FPS or Chaps, SEPA tranfers etc.), credit cards or debit cards. The number of methods available to you will depend on a number of factors. Deposits into your Yafpay account are provided by third parties, for example, the card provider which issued your credit or debit card. We cannot guarantee the use of any particular deposit method and when appropriate, we may restrict or prohibit a particular deposit method at any time without notice to you.
                            We will credit your Yafpay Account once we have received your deposit, and we are only responsible for the funds deposited once we have received it. In certain instances, you may be asked to provide us with evidence of source of funds in order for us to meet our regulatory requirements, in which case you agree to provide that evidence promptly. You represent and warrant to us that the evidence you provide to us is up to date, complete and accurate.
                            Yafpay is not a bank and banking services are provided by third party partner banks. The specified bank account details that we provide to you in order for you to receive funds from third parties are for accounts held by Yafpay (and we will credit your Yafpay Account, which is held by us, upon receipt of such funds), and are not for a bank account held by you. Funds held by Yafpay are not insured by the Federal Deposit Insurance Corporation (FDIC) or any other deposit protection scheme. All Customer Funds are safeguarded; this means Yafpay does not use balances held by its customers for operating expenses or other corporate purposes and will not voluntarily make such funds available to its creditors in the event of bankruptcy.
                    ...
                    <div className='col-md-12 universal_padding mt-5'>
                        <p className='m-0 p-0 yapay_head'>INTELLECTUAL PROPERTY</p>
                        <p className='m-0 p-0 yapay_head1'>
                            Unless otherwise stated, Yafpay and/or its licensors own the intellectual property rights and materials on the website subject to the license below. All text, formatting (including without limitation the arrangement of materials on the Yafpay website and the graphics, animation, tools, commercials, music, video, articles, sound, copy, trade names, logos and other materials and information on the website are subject to the intellectual property rights of Yafpay and its affiliates and their licensors and licensees (collectively the “Content”). We do not grant you any right, license, title or interest to any of our intellectual Property rights which you may or may not have access to. This Content may not be copied, reverse-engineered, decompiled, disassembled, modified or reposted to other websites. Nothing on the Yafpay site should be construed as granting by implication or otherwise, any license or right to use any Trademark displayed on the Yafpay website without the written permission of Yafpay or such third party that may own the Trademark. You agree to take such actions including any legal or official document or other documents that may be needed to further affirm our intellectual property rights.</p>
                    </div>

                    <div className='col-md-12 universal_padding mt-5'>
                        <p className='m-0 p-0 yapay_head'>CONFIDENTIAL INFORMATION
                        </p>
                        <p className='m-0 p-0 yapay_head1'>
                    ...
                    <div className='col-md-12 universal_padding mt-5'>
                        <p className='m-0 p-0 yapay_head'>DISCLAIMERS
                        </p>
                        <p className='m-0 p-0 yapay_head1'>
                            YAFPAY WILL TRY TO ENSURE THAT THE WEBSITE IS AVAILABLE AT ALL TIMES AND BUG-FREE. HOWEVER, IT IS USED AT YOUR OWN RISK.
                            OUR WEBSITE AND SERVICES ARE PROVIDED “AS IS” WITHOUT ANY EXPRESS, IMPLIED AND/OR STATUTORY WARRANTIES (INCLUDING, BUT NOT LIMITED TO, ANY IMPLIED OR STATUTORY WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR USE OR PURPOSE, TITLE, AND NON-INFRINGEMENT OF INTELLECTUAL PROPERTY RIGHTS). WITHOUT LIMITING THE GENERALITY OF THE FOREGOING, YAFPAY MAKES NO WARRANTY THAT OUR WEBSITE AND SERVICES WILL MEET YOUR REQUIREMENTS OR THAT OUR WEBSITE WILL BE UNINTERRUPTED, TIMELY, SECURE, OR ERROR-FREE. NO ADVICE OR INFORMATION, WHETHER ORAL OR WRITTEN, OBTAINED BY YOU THROUGH OUR WEBSITE OR FROM YAFPAY, ITS PARENTS, SUBSIDIARIES, OR OTHER AFFILIATED COMPANIES, OR ITS OR THEIR SUPPLIERS (OR THE RESPECTIVE OFFICERS, DIRECTORS, EMPLOYEES, OR AGENTS OF ANY SUCH ENTITIES) (COLLECTIVELY, "YAFPAY PARTIES") SHALL CREATE ANY WARRANTY.
                    ...
                    <div className='col-md-12 universal_padding mt-5'>
                        <p className='m-0 p-0 yapay_head'>LIMITATION OF LIABILITY
                        </p>
                        <p className='m-0 p-0 yapay_head1'>
                            YOUR USE OF YAFPAY’S SITE AND SERVICES IS AT YOUR OWN RISK. YOU AGREE TO THE LIMITATION LIABILITY CLAUSE TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW: YAFPAY WILL IN NO WAY BE LIABLE FOR ANY DIRECT, INDIRECT, INCIDENTAL PUNITIVE, CONSEQUENTIAL, SPECIAL OR EXEMPLARY DAMAGES OR ANY DAMAGES INCLUDING DAMAGES RESULTING FROM REVENUE LOSS, PROFIT LOSS, USE, DATA, GOODWILL, BUSINESS INTERRUPTION OR ANY OTHER INTANGIBLE LOSSES (WHETHER YAFPAY HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES OR NOT) ARISING OUT OF ABOKI AFRICA’S WEBSITE OR SERVICES (INCLUDING, WITHOUT LIMITATION TO INABILITY TO USE OR ARISING FROM THE RESULT OF USE OF YAFPAY’S WEBSITE OR SERVICES) WHETHER SUCH DAMAGES ARE BASED ON WARRANTY, TORT, CONTRACT, STATUTE OR ANY OTHER LEGAL THEORY.
                    ...
                    <div className='col-md-12 universal_padding mt-5'>
                        <p className='m-0 p-0 yapay_head'>KNOW YOUR CUSTOMER
                        </p>
                        <p className='m-0 p-0 yapay_head1'>
                            ...
                            You are also required to maintain information and proof of service or product delivery to your customer. Where a dispute occurs needing resolution, you may be required to provide Yafpay with these.

                        </p>
                    </div>

                    <div className='col-md-12 universal_padding mt-5'>
                        <p className='m-0 p-0 yapay_head'>INDEMNITY
                        </p>
                        <p className='m-0 p-0 yapay_head1'>
                            You hereby indemnify Yafpay and undertake to keep Yafpay, its staff and affiliates indemnified against any losses, damages, costs, liabilities and expenses (including without limitation reasonable legal fees and expenses) arising out of any breach by you of any provision of these Terms, or arising out of any claim that you have breached any provision of these Terms, or arising from a suspension or other action taken with respect to your Yafpay Account, or arising from your need to modify your practices, content, or behavior, or your loss of or inability to do business, as a result of changes to this Agreement or any other Yafpay policy. You will indemnify and hold Yafpay harmless from and against any claim, suit or proceeding brought against Yafpay arising from or in connection with violations of Intellectual Property or other rights of third parties in relation to your use of the Services.
                            If you have a dispute with any other Yafpay Account holder or a third party that you send money to or receive money from using the Services, you release Yafpay from any and all claims, demands and damages (actual and consequential) of every kind and nature, known and unknown, arising out of or in any way connected with such disputes.

                        </p>
                    </div>

                    <div className='col-md-12 universal_padding mt-5'>
                        <p className='m-0 p-0 yapay_head'>TERMINATION
                        </p>
                        <p className='m-0 p-0 yapay_head1'>
                            You may terminate this Agreement by closing your Yafpay Account.
                            We may, in our sole discretion suspend or close your Yafpay Account and your access to Yafpay’s services and any funds, or terminate this Agreement, If;

                        </p>
                        <p className='m-0 p-0 yapay_head1'>
                            <ul className='mb-0'>
                                <li>You do not comply with or breach any of the provisions of this Agreement;
                                </li>
                                <li>We are required to do so by law, government authority or agency, or law enforcement agency;
                                </li>
                                <li>We are directed by a Card Network or issuing financial institution; or
                                </li>
                                <li>Where a suspicious or fraudulent transaction occurs
                                </li>
                                <li>We have reason to believe you are involved in any fraudulent activity, money laundering, terrorism financing or other criminal or illegal activity.
                                </li>
                            </ul>
                        </p>
                        <p className='m-0 p-0 yapay_head1'>
                            Yafpay may take further actions it deems appropriate to deal with the breach, which may include, suspending your access to the website, prohibiting you from accessing the website and Services, blocking computers using your IP address from accessing the website and Services, contacting your internet service provider to request that they block your access to the website and Services and/or bringing court proceedings against you.
                            We may also suspend your Yafpay Account if it has been compromised or for other security reasons; or has been used or is being used without your authorization or fraudulently.
                            If we close your Yafpay Account or terminate your use of the Services for any reason, we’ll provide you with notice of our actions and make any unrestricted prepaid money held in your Yafpay Account available for withdrawal.  You are responsible for all reversals, chargebacks, fees, fines, penalties and other liability incurred by Yafpay, any other Yafpay customer, or a third party, caused by or arising out of your breach of this Agreement, and/or your use or the use of your authorized third parties of the Services. You agree to reimburse Yafpay, any Yafpay customer, or a third party for any and all such liability.
                    ...
                    <div className='col-md-12 universal_padding mt-5'>
                        <p className='m-0 p-0 yapay_head'>HOW DO I CLOSE MY YAFPAY ACCOUNT
                        </p>
                        <p className='m-0 p-0 yapay_head1'>
                            You may close your Yafpay account at any time by;

                        </p>
                        <p className='m-0 p-0 yapay_head1'>
                            <ul className='mb-0'>
                                <li>Login to your account on the mobile app
                                </li>
                                <li>Navigate to More
                                </li>
                                <li>Select 'Delete your account'
                                </li>
                                <li>Agree to the terms of service
                                </li>
                                <li>Tap the 'Continue with account deletion' button
                                </li>
                                <li>Enter reason for deleting account & account password
                                </li>
                                <li>Tap the 'Delete account' button
                                </li>
                            </ul>
                        </p>
                        <p className='m-0 p-0 yapay_head1'>
                            Pending Payments
                            If there are any pending transactions relating to your Yafpay Account when you initiate account deletion, your Yafpay Account will be closed promptly after such transactions are completed.
                            Remaining Balances
                            Before closing your account, you should empty your currency balances. Unused balances in your Yafpay account may be lost, so ensure to use or remove all the funds in your account. Yafpay will not be liable for any losses that may occur due to failure to remove all funds in your account. To empty your balances, you should;
                        ...
                        <p className='m-0 p-0 yapay_head1'>
                            <ul className='mb-0'>
                                ...
                                <li>On the homepage, select the currency you wish to withdraw funds from
                                </li>
                                <li>Tap the 'Withdraw' button
                                </li>
                                <li>Select 'Withdraw to a saved recipient' or 'Withdraw to another account'
                                </li>
                                <li>Fill required fields on the withdrawal form
                                </li>
                                <li>Tap the 'Continue' button
                                </li>
                                <li>Review your transaction and tap the 'Finish' button
                                </li>
                            </ul>
                        </p>
                        <p className='m-0 p-0 yapay_head1'>
                            You’ll need to do this for each currency you have money in.
                            You must not close your Yafpay Account to avoid an investigation. If you attempt to close your Yafpay Account during an investigation, we may hold your money until the investigation is fully completed. You agree that you will continue to be responsible for all obligations related to your Yafpay Account even after it is closed. As a regulated financial institution, Yafpay is obligated to retain some of your data for purposes such as security, fraud, accounting, reconciliation, anti-money laundering and reporting purposes.

                        </p>
                    </div>

                    <div className='col-md-12 universal_padding mt-5'>
                        <p className='m-0 p-0 yapay_head'>DISPUTE RESOLUTION
                        </p>
                        <p className='m-0 p-0 yapay_head1'>
